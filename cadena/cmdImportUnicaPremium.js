...
//noreplace
/**
 * @chain    cmdImportUnicaPremium
 * @category MASIVO
 * @purpose  Operación por fila de la importación «Carga Masiva UNICA PREMIUM» (producto UNICA_PLA, ramo 31).
