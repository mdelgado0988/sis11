...
- Delimitar siempre con corchetes `[]` los nombres de tablas, columnas y campos que se usen en SQL, especialmente si pueden ser palabras reservadas; por ejemplo, usar `[Transaction]`, `[end]` y `[user]`.
