...
() => {
  ...
  const columns = [
    ...
    { title: t('Cancellations'), dataIndex: 'cancellation', key: 'cancellation', width: 125, align: 'right', render: renderMoney },
    { title: t('Balance'), dataIndex: 'balance', key: 'balance', width: 110, align: 'right', render: renderMoney }
  ];
