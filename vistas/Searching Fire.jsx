 ...
 * @author Noel Obando
 * @created 2025-12-23
 * @summary Search and filter Fire reinsurance accumulation
 * @name viewFireAccumulation
 * @version 1.0.0
...
() => {
  ...
  // --- Iconos extraídos para limpiar el componente principal ---
    ...
    const load = (params = {}) => {
        ...
        const isBarriada = form.buildingType === 2;
        let extraParametros = "";
        ...
        >
            ...
            <Panel title="Policy Filter Search" width={520} placement="right" onClose={() => setVisible(false)} visible={visible}>
                <Form id="formFilter" name="advanced_search" layout="vertical" initialValue={{buildingType:1}}>
                    ...
                    <Row gutter={16}>
                        <Col span={12} className="gutter-row">
                            <Form.Item label={buildingLabel} name="searchName" style={{ width: '100%' }}>
                                <Input
                                    value={searchName}
